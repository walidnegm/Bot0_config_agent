...
def scan_config_directory(**kwargs) -> Dict[str, Any]:
    """
    Recursively scans a directory for config-like files (e.g., .env, .yaml, .json, .toml)
    and summarizes their top-level keys and potential secret-looking fields.
